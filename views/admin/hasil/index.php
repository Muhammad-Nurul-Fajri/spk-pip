...
.table tbody td:nth-child(4) { text-align: left !important; padding-left: 20px; }
.table tbody tr:hover td { background: #e8f5e9; }
.btn-print { background: #ffc107; color: white; border: none; padding: 10px 20px; border-radius: 10px; font-weight: bold; transition: 0.3s; }
.btn-print:hover { background: #e0a800; color: white; }
@media print {
    .sidebar, .navbar-custom, .btn-print, .no-print { display: none !important; }
...
<div class="sidebar">
    ...
    <ul class="menu">
        ...
        <li><a href="index.php" class="active"><i class="fa fa-trophy"></i> Data Hasil Akhir</a></li>
...
<div class="content">
    ...
    <div class="card-custom">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
                <h5 class="mb-1">Perangkingan Penerima Bantuan PIP</h5>
                <p class="text-muted mb-0 small">Hasil analisis metode Weighted Product (WP)</p>
            </div>
        ...
        <div class="table-responsive">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Nama Siswa</th>
                            <th width="14%">Nilai S</th>
                            <th width="14%">Nilai V</th>
            ...
            <?php else: ?>
                <div class="text-center py-5 text-muted">
                    <i class="fa fa-trophy mb-3" style="font-size: 40px; color: #ddd;"></i>
                    <p>Belum ada hasil perhitungan. Silakan lakukan perhitungan terlebih dahulu di menu <strong>Data Perhitungan</strong>.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
