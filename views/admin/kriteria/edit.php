...
// Ambil data kriteria
$query = mysqli_query($koneksi, "SELECT * FROM kriteria WHERE id = $id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($kode_kriteria)) {
        ...
        $cek_kode = mysqli_query($koneksi, "SELECT id FROM kriteria WHERE kode_kriteria = '$kode_kriteria' AND id != $id");
        if (!$cek_kode) {
            ...
            $cek_nama = mysqli_query($koneksi, "SELECT id FROM kriteria WHERE nama_kriteria = '$nama_kriteria' AND id != $id");
            if (!$cek_nama) {
                $pesan_error = 'Error: ' . mysqli_error($koneksi);
        ...
        <form method="POST" action="">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="kode_kriteria" class="form-control" placeholder="Contoh: C1" value="<?php echo htmlspecialchars($data['kode_kriteria']); ?>" required>
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Nama Kriteria <span class="required">*</span></label>
                    <input type="text" name="nama_kriteria" class="form-control" placeholder="Masukkan nama kriteria" value="<?php echo htmlspecialchars($data['nama_kriteria']); ?>" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="d-flex">
                        <input type="number" name="bobot" class="form-control" placeholder="Masukkan bobot" step="1" min="0" max="100" value="<?php echo htmlspecialchars($data['bobot']); ?>" required>
