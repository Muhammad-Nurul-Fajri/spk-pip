...
.header-data { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; }
.btn-add { background: #4caf50; color: white; border-radius: 10px; font-weight: bold; padding: 9px 18px; font-size: 14px; border: none; transition: 0.3s; }
.btn-add:hover { background: #388e3c; color: white; }
.table thead th { background: #4caf50; color: white; text-align: center; vertical-align: middle; }
.table tbody td { text-align: center; vertical-align: middle; background: white; }
.table tbody td:nth-child(3) { text-align: left !important; padding-left: 20px; }
.table tbody tr:hover td { background: #e8f5e9; }
.btn-edit { background: #ffc107; color: white; border: none; width: 28px; height: 28px; border-radius: 6px; display: inline-flex; align-items: center; justify-content: center; text-decoration: none; font-size: 12px; }
.btn-edit:hover { background: #e0a800; color: white; }
.btn-delete { background: #dc3545; color: white; border: none; width: 28px; height: 28px; border-radius: 6px; display: inline-flex; align-items: center; justify-content: center; text-decoration: none; font-size: 12px; }
.btn-delete:hover { background: #c82333; color: white; }
.badge-admin { background: #e3f2fd; color: #1565c0; padding: 4px 10px; border-radius: 20px; font-size: 12px; font-weight: bold; }
.badge-ketua { background: #fff3e0; color: #e65100; padding: 4px 10px; border-radius: 20px; font-size: 12px; font-weight: bold; }
.badge-siswa { background: #e8f5e9; color: #2e7d32; padding: 4px 10px; border-radius: 20px; font-size: 12px; font-weight: bold; }
...
<div class="sidebar">
    ...
    <ul class="menu">
        ...
        <li><a href="index.php" class="active"><i class="fa fa-users"></i> Data User</a></li>
        ...
        <div class="table-responsive">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif ($row['role'] == 'ketua_yayasan'): ?>
                                        <span class="badge-ketua">Ketua Yayasan</span>
                                    <?php else: ?>
            ...
            <?php else: ?>
                <div class="text-center py-5 text-muted">
                    <i class="fa fa-users mb-3" style="font-size: 40px; color: #ddd;"></i>
